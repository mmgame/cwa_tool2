...
public class MemberZKInfoConfigDao implements IMemberZKInfoConfigDao {
	private IMemberZKInfoConfigDao dao;

	protected IOperatePool operatePool;// 操作池
	protected DaoOperateFactory daoOperateFactory;// 数据操作工厂
	
	@Override
	public List<MemberZKInfoConfig> selectEntity(IKey key, Object attach) {
	...
	public MemberZKInfoConfig selectEntityByGid(int gid,Object attach) {
		MemberZKInfoConfig entity =( MemberZKInfoConfig)dao.selectEntityByGid(gid, attach);
		if(entity != null){
		   entity.obtainAfter();
		}
		return entity;
	...
	@Override
	public List<MemberZKInfoConfig> selectAllEntity(Object attach) {
	    List<MemberZKInfoConfig> entitys = dao.selectAllEntity(attach);
	    for (MemberZKInfoConfig entity : entitys) {
	        entity.obtainAfter();
		}
		return entitys;
	}
	...
	@Override
	public void insertEntity(MemberZKInfoConfig entity, Object attach) {
	    entity.saveBefore();
	...
	@Override
	public void updateEntity(MemberZKInfoConfig entity, Object attach) {
	    entity.saveBefore();
	...
	@Override
	public void removeEntity(MemberZKInfoConfig entity, Object attach) {
		IDaoOperate daoOperate = daoOperateFactory.createDaoOperate(dao, DaoOperateType.Remove, entity, "", null, attach);
		operatePool.execute(daoOperate);
	}

	@Override
	public void batchInsertEntity(List<MemberZKInfoConfig> entitys, Object attach) {
	    for (MemberZKInfoConfig entity : entitys) {
	        entity.saveBefore();
		}
	...
	@Override
	public void batchUpdateEntity(List<MemberZKInfoConfig> entitys, Object attach) {
	    for (MemberZKInfoConfig entity : entitys) {
	        entity.saveBefore();
		}
	...
	@Override
	public void batchRemoveEntity(List<MemberZKInfoConfig> entitys, Object attach) {
	...
	public void setDao(IMemberZKInfoConfigDao dao) {
		this.dao = dao;
	}
