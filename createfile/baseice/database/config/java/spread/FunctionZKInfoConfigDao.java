...
public class FunctionZKInfoConfigDao implements IFunctionZKInfoConfigDao {
	private IFunctionZKInfoConfigDao dao;

	protected IOperatePool operatePool;// 操作池
	protected DaoOperateFactory daoOperateFactory;// 数据操作工厂
	
	@Override
	public List<FunctionZKInfoConfig> selectEntity(IKey key, Object attach) {
	...
	public FunctionZKInfoConfig selectEntityByGid(int gid,Object attach) {
		FunctionZKInfoConfig entity =( FunctionZKInfoConfig)dao.selectEntityByGid(gid, attach);
		if(entity != null){
		   entity.obtainAfter();
		}
		return entity;
	...
	@Override
	public List<FunctionZKInfoConfig> selectAllEntity(Object attach) {
	    List<FunctionZKInfoConfig> entitys = dao.selectAllEntity(attach);
	    for (FunctionZKInfoConfig entity : entitys) {
	        entity.obtainAfter();
		}
		return entitys;
	}
	...
	@Override
	public void insertEntity(FunctionZKInfoConfig entity, Object attach) {
	    entity.saveBefore();
	...
	@Override
	public void updateEntity(FunctionZKInfoConfig entity, Object attach) {
	    entity.saveBefore();
	...
	@Override
	public void removeEntity(FunctionZKInfoConfig entity, Object attach) {
		IDaoOperate daoOperate = daoOperateFactory.createDaoOperate(dao, DaoOperateType.Remove, entity, "", null, attach);
		operatePool.execute(daoOperate);
	}

	@Override
	public void batchInsertEntity(List<FunctionZKInfoConfig> entitys, Object attach) {
	    for (FunctionZKInfoConfig entity : entitys) {
	        entity.saveBefore();
		}
	...
	@Override
	public void batchUpdateEntity(List<FunctionZKInfoConfig> entitys, Object attach) {
	    for (FunctionZKInfoConfig entity : entitys) {
	        entity.saveBefore();
		}
	...
	@Override
	public void batchRemoveEntity(List<FunctionZKInfoConfig> entitys, Object attach) {
	...
	public void setDao(IFunctionZKInfoConfigDao dao) {
		this.dao = dao;
	}
