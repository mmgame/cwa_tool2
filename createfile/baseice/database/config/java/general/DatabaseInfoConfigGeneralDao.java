...
public class DatabaseInfoConfigGeneralDao implements IDatabaseInfoConfigDao {
	protected static String namespace = DatabaseInfoConfig.class.getCanonicalName();

	public DatabaseInfoConfigGeneralDao() {
	}
	...
	public DatabaseInfoConfig selectEntityByGidAndDbid(int gid,int dbid,Object attach) {
		...
		List<DatabaseInfoConfig> list = sqlSessionTemplate.selectList(namespace + ".selectByGidAndDbid", paras);
