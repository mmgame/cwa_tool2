...
public class HttpServiceConfigGeneralDao implements IHttpServiceConfigDao {
	protected static String namespace = HttpServiceConfig.class.getCanonicalName();

	public HttpServiceConfigGeneralDao() {
	}
	...
	public HttpServiceConfig selectEntityByGidAndFtypeAndKey(int gid,int ftype,String key,Object attach) {
		...
		List<HttpServiceConfig> list = sqlSessionTemplate.selectList(namespace + ".selectByGidAndFtypeAndKey", paras);
