...
public class UsereconomyEntityDao implements IUsereconomyEntityDao {
	...
	public UsereconomyEntity selectEntityByUserIdAndMoneyType(long userId,int moneyType,Object attach) {
		UsereconomyEntity entity =( UsereconomyEntity)dao.selectEntityByUserIdAndMoneyType(userId, moneyType, attach);
		if(entity != null){
		   entity.obtainAfter();
		}
		return entity;
	...
	public List<UsereconomyEntity> selectEntityByUserId(long userId,Object attach) {
		List<UsereconomyEntity> entitys = dao.selectEntityByUserId(userId, attach);
	...
	public List<UsereconomyEntity> selectAllEntity(Object attach) {
	    List<UsereconomyEntity> entitys = dao.selectAllEntity(attach);
	    for (UsereconomyEntity entity : entitys) {
	        entity.obtainAfter();
		}
		return entitys;
	...
	public void setDao(IUsereconomyEntityDao dao) {
		this.dao = dao;
	}
