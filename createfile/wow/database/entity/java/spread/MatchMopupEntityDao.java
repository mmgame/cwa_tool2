...
public class MatchMopupEntityDao implements IMatchMopupEntityDao {
	...
	@Override
	public List<MatchMopupEntity> selectEntity(IKey key, Object attach) {
	...
	public MatchMopupEntity selectEntityByUserId(long userId,Object attach) {
		MatchMopupEntity entity =( MatchMopupEntity)dao.selectEntityByUserId(userId, attach);
		if(entity != null){
		   entity.obtainAfter();
		}
		return entity;
	...
	@Override
	public List<MatchMopupEntity> selectAllEntity(Object attach) {
	    List<MatchMopupEntity> entitys = dao.selectAllEntity(attach);
	    for (MatchMopupEntity entity : entitys) {
	        entity.obtainAfter();
		}
		return entitys;
	}
	...
	@Override
	public void insertEntity(MatchMopupEntity entity, Object attach) {
	    entity.saveBefore();
	...
	@Override
	public void updateEntity(MatchMopupEntity entity, Object attach) {
	    entity.saveBefore();
	...
	@Override
	public void removeEntity(MatchMopupEntity entity, Object attach) {
		IDaoOperate daoOperate = daoOperateFactory.createDaoOperate(dao, DaoOperateType.Remove, entity, "", null, attach);
		operatePool.execute(daoOperate);
	}

	@Override
	public void batchInsertEntity(List<MatchMopupEntity> entitys, Object attach) {
	    for (MatchMopupEntity entity : entitys) {
	        entity.saveBefore();
		}
	...
	@Override
	public void batchUpdateEntity(List<MatchMopupEntity> entitys, Object attach) {
	    for (MatchMopupEntity entity : entitys) {
	        entity.saveBefore();
		}
	...
	@Override
	public void batchRemoveEntity(List<MatchMopupEntity> entitys, Object attach) {
	...
	public void setDao(IMatchMopupEntityDao dao) {
		this.dao = dao;
	}
