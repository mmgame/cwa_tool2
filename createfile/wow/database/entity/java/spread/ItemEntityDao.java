...
public class ItemEntityDao implements IItemEntityDao {
	...
	public ItemEntity selectEntityByUserIdAndItemId(long userId,int itemId,Object attach) {
		ItemEntity entity =( ItemEntity)dao.selectEntityByUserIdAndItemId(userId, itemId, attach);
		if(entity != null){
		   entity.obtainAfter();
		}
		return entity;
	...
	public List<ItemEntity> selectEntityByUserId(long userId,Object attach) {
		List<ItemEntity> entitys = dao.selectEntityByUserId(userId, attach);
	...
	public List<ItemEntity> selectAllEntity(Object attach) {
	    List<ItemEntity> entitys = dao.selectAllEntity(attach);
	    for (ItemEntity entity : entitys) {
	        entity.obtainAfter();
		}
		return entitys;
	...
	public void setDao(IItemEntityDao dao) {
		this.dao = dao;
	}
