...
public class RegionEntityDao implements IRegionEntityDao {
	...
	@Override
	public List<RegionEntity> selectEntity(IKey key, Object attach) {
	...
	public RegionEntity selectEntityByRid(int rid,Object attach) {
		RegionEntity entity =( RegionEntity)dao.selectEntityByRid(rid, attach);
		if(entity != null){
		   entity.obtainAfter();
		}
		return entity;
	...
	@Override
	public List<RegionEntity> selectAllEntity(Object attach) {
	    List<RegionEntity> entitys = dao.selectAllEntity(attach);
	    for (RegionEntity entity : entitys) {
	        entity.obtainAfter();
		}
		return entitys;
	}
	...
	@Override
	public void insertEntity(RegionEntity entity, Object attach) {
	    entity.saveBefore();
	...
	@Override
	public void updateEntity(RegionEntity entity, Object attach) {
	    entity.saveBefore();
	...
	@Override
	public void removeEntity(RegionEntity entity, Object attach) {
		IDaoOperate daoOperate = daoOperateFactory.createDaoOperate(dao, DaoOperateType.Remove, entity, "", null, attach);
		operatePool.execute(daoOperate);
	}

	@Override
	public void batchInsertEntity(List<RegionEntity> entitys, Object attach) {
	    for (RegionEntity entity : entitys) {
	        entity.saveBefore();
		}
	...
	@Override
	public void batchUpdateEntity(List<RegionEntity> entitys, Object attach) {
	    for (RegionEntity entity : entitys) {
	        entity.saveBefore();
		}
	...
	@Override
	public void batchRemoveEntity(List<RegionEntity> entitys, Object attach) {
	...
	public void setDao(IRegionEntityDao dao) {
		this.dao = dao;
	}
