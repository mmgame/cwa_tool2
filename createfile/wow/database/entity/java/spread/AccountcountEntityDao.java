...
public class AccountcountEntityDao implements IAccountcountEntityDao {
	...
	public AccountcountEntity selectEntityByAid(int aid,Object attach) {
		AccountcountEntity entity =( AccountcountEntity)dao.selectEntityByAid(aid, attach);
		if(entity != null){
		   entity.obtainAfter();
		}
		return entity;
	...
	public List<AccountcountEntity> selectAllEntity(Object attach) {
	    List<AccountcountEntity> entitys = dao.selectAllEntity(attach);
	    for (AccountcountEntity entity : entitys) {
	        entity.obtainAfter();
		}
		return entitys;
	}
	...
	public void setDao(IAccountcountEntityDao dao) {
		this.dao = dao;
	}
