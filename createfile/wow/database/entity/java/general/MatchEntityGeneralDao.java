...
public class MatchEntityGeneralDao implements IMatchEntityDao {
	protected static String namespace = MatchEntity.class.getCanonicalName();

	public MatchEntityGeneralDao() {
	}
	...
	public MatchEntity selectEntityByUserIdAndMatchType(long userId,int matchType,Object attach) {
		...
		List<MatchEntity> list = sqlSessionTemplate.selectList(namespace + ".selectByUserIdAndMatchType", paras);
