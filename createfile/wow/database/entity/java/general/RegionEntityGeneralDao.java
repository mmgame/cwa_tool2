...
public class RegionEntityGeneralDao implements IRegionEntityDao {
	protected static String namespace = RegionEntity.class.getCanonicalName();

	public RegionEntityGeneralDao() {
	}
	...
	public RegionEntity selectEntityByRid(int rid,Object attach) {
		...
		List<RegionEntity> list = sqlSessionTemplate.selectList(namespace + ".selectByRid", paras);
