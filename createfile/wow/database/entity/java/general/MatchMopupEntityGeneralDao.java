...
public class MatchMopupEntityGeneralDao implements IMatchMopupEntityDao {
	protected static String namespace = MatchMopupEntity.class.getCanonicalName();

	public MatchMopupEntityGeneralDao() {
	}
	...
	public MatchMopupEntity selectEntityByUserId(long userId,Object attach) {
		...
		List<MatchMopupEntity> list = sqlSessionTemplate.selectList(namespace + ".selectByUserId", paras);
