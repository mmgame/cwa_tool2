...
public class VipEntityGeneralDao implements IVipEntityDao {
	protected static String namespace = VipEntity.class.getCanonicalName();

	public VipEntityGeneralDao() {
	}
	...
	public VipEntity selectEntityByUserId(long userId,Object attach) {
		...
		List<VipEntity> list = sqlSessionTemplate.selectList(namespace + ".selectByUserId", paras);
