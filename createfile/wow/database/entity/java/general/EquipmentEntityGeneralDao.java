...
public class EquipmentEntityGeneralDao implements IEquipmentEntityDao {
	protected static String namespace = EquipmentEntity.class.getCanonicalName();

	public EquipmentEntityGeneralDao() {
	}
	...
	public EquipmentEntity selectEntityByUserIdAndHeroIdAndPositionId(long userId,int heroId,int positionId,Object attach) {
		...
		paras.put("positionId", positionId);
		SqlSession sqlSessionTemplate = (SqlSession) paras.get("sql_session");
		List<EquipmentEntity> list = sqlSessionTemplate.selectList(namespace + ".selectByUserIdAndHeroIdAndPositionId", paras);
	...
	public List<EquipmentEntity> selectEntityByUserIdAndHeroId(long userId,int heroId,Object attach) {
		...
		paras.put("heroId", heroId);
		SqlSession sqlSessionTemplate = (SqlSession) paras.get("sql_session");
		return sqlSessionTemplate.selectList(namespace + ".selectByUserIdAndHeroId", paras);
	}
	@SuppressWarnings("unchecked")
	@Override
