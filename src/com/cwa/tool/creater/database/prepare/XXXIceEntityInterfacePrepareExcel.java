...
public class XXXIceEntityInterfacePrepareExcel extends AbstractDBTemplatePrepare {
	...
	public String getFtlFilePath(IStructure structure) {
		return "db" + File.separator + "XXXIceEntityInterface.ftl";
	}
	...
	public File getFile(IStructure structure) throws Exception {
		...
		String path = dbc.getCreateFilePath() + File.separator + "java";
		FileUtil.createDirectory(path);

		String fileName = structure == null ? "" : getEntityName(s);
		return new File(path + File.separator + "I" + StringUtil.upperFirstString(fileName) + "Dao.java");
	}
