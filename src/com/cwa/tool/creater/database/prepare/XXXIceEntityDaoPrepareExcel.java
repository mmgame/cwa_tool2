...
public class XXXIceEntityDaoPrepareExcel extends AbstractDBTemplatePrepare {
	...
	public String getFtlFilePath(IStructure structure) {
		return "db" + File.separator + "XXXIceEntityDao.ftl";
	}
	...
	public File getFile(IStructure structure) throws Exception {
		...
		String path = dbc.getCreateFilePath() + File.separator + "java" + File.separator + "spread";
		FileUtil.createDirectory(path);

		String fileName = structure == null ? "" : getEntityName(s);
		return new File(path + File.separator + StringUtil.upperFirstString(fileName) + "Dao.java");
	}
